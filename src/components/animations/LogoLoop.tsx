...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    // FIX: Menambahkan trackRef ke dependency array untuk menghilangkan error linter
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        // FIX: Pindahkan style dinamis ke object style untuk menghindari warning linter Tailwind
        ...
        if (renderItem) {
          return (
            <li
              className={cx(
                'flex-none leading-none', // 'leading-[1]' diganti 'leading-none'
                scaleOnHover && 'overflow-visible group/item'
              )}
              style={listItemStyle} // Gunakan style prop
              key={key}
              role="listitem"
            >
              {renderItem(item, key)}
        ...
        if (isNode) {
          ...
          content = (
            <span
              className={cx(
                ...
                // 'ease-in-out' lebih standar dibanding cubic-bezier manual
                scaleOnHover &&
          ...
          content = (
            ...
            <img
              className={cx(
                'w-auto block object-contain', // 'h-[...]' dipindah ke style
              ...
              style={{ height: 'var(--logoloop-logoHeight)' }} // Style untuk tinggi gambar
              src={item.src}
              srcSet={item.srcSet}
              sizes={item.sizes}
              width={item.width}
